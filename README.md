...
report the decoder-to-encoder cross-attention/CE/backward/AdamW smoke as
completed while keeping the full encoder-decoder loop, complete loss
composition in the missing list. TTT
