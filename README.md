...
stayed rejected: setup improved to `0.950708x`, but train-loop wall regressed
to `1.058712x`, startup-plus-first-step regressed to `1.035125x`, and
tokens/sec fell to `0.944542x`. A 2026-06-28
