...
entries now report the denoise-head linear/MSE/backward/AdamW smoke as
completed while keeping timestep scheduling, full objective composition, and
family checkpoint/inference wiring in the missing list. Seq2seq entries now
