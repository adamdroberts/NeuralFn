...
keeping family checkpoint/inference wiring in the missing list. HNet entries now report
the byte patch embed/merge plus head-loss/backward/AdamW smoke as completed
while keeping byte-token shard resolution, byte-patch backward, and family
checkpoint/inference wiring in the missing list.
