...
RoPE, SwiGLU/GEGLU, and LM-head CE/backward/AdamW, while their missing list is
limited to packed-QKV RoPE attention block integration, the full LLaMA block
...
input/weight backward, and AdamW. These are coverage gates for the LLaMA loop
wiring, not a complete LLaMA trainer.
