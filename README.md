...
now report byte patch embed/merge plus head-loss/backward/AdamW and byte patch
merge/embed-backward/AdamW smokes as completed while keeping byte-token shard
resolution and family checkpoint/inference wiring in the missing list.
