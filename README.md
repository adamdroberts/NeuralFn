...
missing list. Universal transformer entries now report the recurrent
linear/MSE/backward/AdamW smoke as completed while keeping ACT halting and
family checkpoint/inference wiring in the missing list. HNet entries now report
