...
MoE full forward/backward loop smoke; standard MoE-only families now have no
remaining native-training requirements listed in preflight JSON. Diffusion
