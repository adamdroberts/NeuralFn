...
target-encoder latent-pool/projection smoke plus the projector/predictor/latent
loss smoke as completed while keeping full AR+JEPA, semantic, route-objective
composition, family loop integration, checkpointing, and inference wiring in
the missing list.
