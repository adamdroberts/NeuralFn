...
class TrainingRun(Base):
    ...
    runtime: Mapped[str] = mapped_column(String(64), default="scalar", nullable=False)
    ...
    compatibility_report: Mapped[dict] = mapped_column(JSON, default=dict, nullable=False)
