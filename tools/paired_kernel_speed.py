...
NATIVE_METRIC_PATHS = (
    ...
    ("train_loss_every_steps", ("train_loss_every_steps",)),
    ...
    ("schedule.max_steps", ("schedule", "max_steps")),
    ("schedule.train_batch_tokens", ("schedule", "train_batch_tokens")),
    ("schedule.train_loss_every_steps", ("schedule", "train_loss_every_steps")),
    ("schedule.eval_every_steps", ("schedule", "eval_every_steps")),
    ("schedule.eval_batches", ("schedule", "eval_batches")),
    ("schedule.eval_batch_size", ("schedule", "eval_batch_size")),
    ("schedule.sample_every_steps", ("schedule", "sample_every_steps")),
    ("schedule.generate_tokens", ("schedule", "generate_tokens")),
    ("schedule.checkpoint_every_steps", ("schedule", "checkpoint_every_steps")),
    ("schedule.warmup_steps", ("schedule", "warmup_steps")),
    ("optimizer.learning_rate", ("optimizer", "learning_rate")),
    ("optimizer.final_lr_fraction", ("optimizer", "final_lr_fraction")),
...
NATIVE_ROUTE_COUNTER_KEYS = (
    ...
    "linear_bf16_cached_a_pack_count",
    "linear_bf16_cached_b_pack_count",
    "linear_bf16_transient_a_pack_count",
    "linear_bf16_transient_b_pack_count",
...
NATIVE_TEXT_METRIC_KEYS = (
    ...
    "schedule.max_steps",
    "schedule.train_batch_tokens",
    "schedule.train_loss_every_steps",
    "schedule.eval_every_steps",
    "schedule.eval_batches",
    "schedule.eval_batch_size",
    "schedule.sample_every_steps",
    "schedule.generate_tokens",
    "schedule.checkpoint_every_steps",
    "schedule.warmup_steps",
    "optimizer.learning_rate",
    "optimizer.final_lr_fraction",
