...
SAMPLES="$(env_or_alias3 NFN_SM120_NATIVE_SAMPLES NFN_SM120_PARITY_SAMPLES NFN_SM120_SAMPLES 1)"
WARMUP="$(env_or_alias3 NFN_SM120_NATIVE_WARMUP NFN_SM120_PARITY_WARMUP NFN_SM120_WARMUP 0)"
...
REQUIRE_NATIVE_LM_HEAD_TRUE_FUSED="$(env_or_alias4 NFN_SM120_NATIVE_REQUIRE_LM_HEAD_TRUE_FUSED NFN_SM120_NATIVE_REQUIRE_NATIVE_LM_HEAD_TRUE_FUSED NFN_SM120_PARITY_REQUIRE_NATIVE_LM_HEAD_TRUE_FUSED NFN_SM120_REQUIRE_NATIVE_LM_HEAD_TRUE_FUSED "$ENFORCE_GATE")"
