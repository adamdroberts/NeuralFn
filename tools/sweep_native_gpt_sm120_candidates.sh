...
header = [
    ...
    "qkv_concurrent_dinput_dweight",
    "mlp_fc_concurrent_dinput_dweight",
    "attn_proj_concurrent_dinput_dweight",
    "lm_head_loss_bin_launches",
    "lm_head_true_fused_launches",
...
for item in sys.argv[2:]:
    ...
    rows.append(
        [
            ...
            route_delta(payload, "block_backward_qkv_concurrent_dinput_dweight_count"),
            route_delta(payload, "block_backward_mlp_fc_concurrent_dinput_dweight_count"),
            route_delta(payload, "block_backward_attn_proj_concurrent_dinput_dweight_count"),
            route_delta(payload, "lm_head_classifier_loss_bin_launch_count"),
            route_delta(payload, "lm_head_classifier_true_fused_launch_count"),
