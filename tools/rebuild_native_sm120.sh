...
NFN_NATIVE_STRICT_INFERENCE_TILE_OPS_OUT="${OUT_DIR}/libnfn_native_train_tile_ops_strict.so" \
...
NFN_NATIVE_BUILD_STRICT_TILE_OPS=0 \
...
bash "${ROOT_DIR}/tools/build_native_nfn_cli.sh" "${OUT_DIR}/nfn_native"
