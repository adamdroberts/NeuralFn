...
AUTO_REBUILD_NATIVE="${NFN_NATIVE_GPT_AUTO_REBUILD:-${NFN_SM120_AUTO_REBUILD:-1}}"
...
WARMUP_STEPS="$(env_or_alias3 NFN_NATIVE_GPT_WARMUP_STEPS NFN_SM120_NATIVE_WARMUP_STEPS NFN_SM120_WARMUP_STEPS 1000)"
...
llm.kittens/train-sm120.sh, with NeuralFn quality defaults for validation and warmup:
  ...
  lr=0.0006 final_lr_fraction=0 warmup=1000 checkpoint=200
