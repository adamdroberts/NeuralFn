...
EVAL_EVERY_STEPS="$(env_or_alias3 NFN_NATIVE_GPT_EVAL_EVERY_STEPS NFN_SM120_NATIVE_EVAL_EVERY_STEPS NFN_SM120_EVAL_EVERY_STEPS 250)"
...
llm.kittens/train-sm120.sh, with NeuralFn validation batches on the same cadence:
  ...
  lr=0.0006 final_lr_fraction=0 warmup=60 checkpoint=200
