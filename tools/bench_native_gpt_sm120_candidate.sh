...
WARMUP="$(env_or_alias5 NFN_SM120_NATIVE_WARMUP NFN_SM120_NATIVE_CANDIDATE_WARMUP NFN_SM120_CANDIDATE_WARMUP NFN_SM120_PARITY_WARMUP NFN_SM120_WARMUP 40)"
USER_WARMUP_SET=0
...
LONG_RUN_DEFER_PREWARM_MIN_WARMUP="$(env_or_alias NFN_SM120_NATIVE_LONG_RUN_DEFER_PREWARM_MIN_WARMUP NFN_SM120_CANDIDATE_LONG_RUN_DEFER_PREWARM_MIN_WARMUP 40)"
