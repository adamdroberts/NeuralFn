...
case "${CANDIDATE_PROFILE,,}" in
  ...
  "linear_bias_row_chunk_256"|"linear-bias-row-chunk-256"|"bgrad_row_chunk_256"|"bgrad-row-chunk-256")
    REJECTED_CANDIDATE_PROFILE="$CANDIDATE_PROFILE"
    REJECTED_CANDIDATE_REASON="CUDA 13.3 dedicated RTX 5090 2-step, 2-sample stage-timed gate changed the bias reducer chunk from 512 to 256 rows and improved train_loop_wall_ms_per_step to 0.997526x, but rejected it because stage.block_backward.total_ms regressed to 1.009570x and stage.block_backward.mlp_fc.dweight_bias.total_ms regressed to 1.000482x."
  ...
  "qkv_dinput_before_dweight"|"qkv-dinput-before-dweight")
    REJECTED_CANDIDATE_PROFILE="$CANDIDATE_PROFILE"
    REJECTED_CANDIDATE_REASON="CUDA 13.3 dedicated RTX 5090 2026-06-24 rerun proved the route counter moved 0->288 and improved train_loop_wall_ms_per_step to 0.994580x, but rejected default promotion because train_loop_cuda_event_steady_state_wall_ms_per_step regressed to 1.000517x, stage.lm_head_backward.total_ms to 1.000122x, stage.block_backward.mlp_proj.total_ms to 1.002745x, and stage.block_backward.qkv.total_ms to 1.000860x."
