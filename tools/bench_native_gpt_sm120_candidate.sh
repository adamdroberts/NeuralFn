...
case "${CANDIDATE_PROFILE,,}" in
  ...
  "llmk_sm120_reference_flags"|"llmk-sm120-reference-flags"|"llm_kittens_sm120_reference_flags"|"llm-kittens-sm120-reference-flags")
    REJECTED_CANDIDATE_PROFILE="$CANDIDATE_PROFILE"
    REJECTED_CANDIDATE_REASON="CUDA 13.3 dedicated RTX 5090 2026-06-24 3-step, 2-sample gate rebuilt the documented llm.kittens SM120 reference macro bundle, changed no tracked route or strategy counters, improved train-loop wall to 0.994499x and tokens/sec to 1.005630x, but rejected default promotion because steady-state CUDA-event timing missed at 1.000331x and stage.block_backward.mlp_proj.dinput.total_ms missed at 1.000032x."
    FORCE_DISABLE_ROUTE_CHANGE=1
