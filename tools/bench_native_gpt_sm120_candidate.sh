...
case "${CANDIDATE_PROFILE,,}" in
  ...
  "bf16_persistent_block_outputs6"|"bf16-persistent-block-outputs6"|"bf16_persistent_block_outputs_6"|"bf16-persistent-block-outputs-6")
    ...
    BASELINE_ENV_RAW="${BASELINE_ENV_RAW:+$BASELINE_ENV_RAW }NFN_NATIVE_GPT_BF16_PERSISTENT_BLOCK_OUTPUTS=0 NFN_NATIVE_GPT_BF16_PERSISTENT_BLOCK_OUTPUT_COUNT=0 NFN_NATIVE_GPT_BF16_PERSISTENT_BLOCK_INPUT_LN1_BACKWARD=0"
    CANDIDATE_ENV_RAW="${CANDIDATE_ENV_RAW:+$CANDIDATE_ENV_RAW }NFN_NATIVE_GPT_BF16_PERSISTENT_BLOCK_OUTPUT_COUNT=6 NFN_NATIVE_GPT_BF16_PERSISTENT_BLOCK_INPUT_LN1_BACKWARD=0"
