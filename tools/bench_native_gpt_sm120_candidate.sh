...
case "${CANDIDATE_PROFILE,,}" in
  ...
  "lm_head_graph_body_cublaslt_dhidden"|"lm-head-graph-body-cublaslt-dhidden"|"lm_head_cooperative_graph_body_cublaslt_dhidden"|"lm-head-cooperative-graph-body-cublaslt-dhidden")
    REJECTED_CANDIDATE_PROFILE="$CANDIDATE_PROFILE"
    REJECTED_CANDIDATE_REASON="Diagnostic split of the rejected LM-head graph-body cuBLASLt route. It routes only the cooperative CUDA graph body dHidden GEMM through the existing strided cuBLASLt kernel while leaving dWeight on the default Tile launcher; keep rejected until a same-script gate beats the default graph body."
  ...
  "lm_head_graph_body_cublaslt_dweight"|"lm-head-graph-body-cublaslt-dweight"|"lm_head_cooperative_graph_body_cublaslt_dweight"|"lm-head-cooperative-graph-body-cublaslt-dweight")
    REJECTED_CANDIDATE_PROFILE="$CANDIDATE_PROFILE"
    REJECTED_CANDIDATE_REASON="Diagnostic split of the rejected LM-head graph-body cuBLASLt route. It routes only the cooperative CUDA graph body dWeight GEMM through the existing strided cuBLASLt kernel while leaving dHidden on the default Tile launcher; keep rejected until a same-script gate beats the default graph body."
