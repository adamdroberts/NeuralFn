...
build_one "hnet-lm" "nfn_hnet_lm_native_train" \
  ...
  "byte-token-shard-resolver,family-parameter-layout-checkpoint-inference" \
  "hnet-byte-patch-embed-merge-head-adamw-smoke,hnet-byte-patch-backward-adamw-smoke"
