...
build_one "mixllama" "nfn_mixllama_native_train" \
  ...
  "router-topk-broadcast-smoke,routed-swiglu-expert-forward-backward-smoke,load-balance-loss-adamw-smoke,standard-moe-transformer-block-forward-smoke,standard-moe-transformer-block-forward-backward-adamw-smoke,standard-moe-transformer-lm-forward-backward-adamw-smoke,family-parameter-layout-checkpoint-inference-smoke"
build_one "moe-jepa-evo" "nfn_moe_jepa_evo_native_train" \
  ...
  "standard-moe-full-forward-backward-loop,ar-plus-jepa-plus-router-loss-composition" \
  "router-topk-broadcast-smoke,routed-swiglu-expert-forward-backward-smoke,load-balance-loss-adamw-smoke,standard-moe-transformer-block-forward-smoke,standard-moe-transformer-block-forward-backward-adamw-smoke,standard-moe-transformer-lm-forward-backward-adamw-smoke,jepa-target-encoder-forward-smoke,jepa-projector-predictor-latent-loss-smoke,ar-plus-jepa-loss-composition-smoke,dense-jepa-ar-target-projector-forward-backward-adamw-smoke,family-parameter-layout-checkpoint-inference-smoke"
...
build_one "semantic-dense-jepa" "nfn_semantic_dense_jepa_native_train" \
  ...
  "jepa-target-encoder-forward-smoke,jepa-projector-predictor-latent-loss-smoke,ar-plus-jepa-loss-composition-smoke,dense-jepa-ar-target-projector-forward-backward-adamw-smoke,semantic-hash-alignment-loss-items-smoke,semantic-dense-planner-alignment-adamw-smoke,family-parameter-layout-checkpoint-inference-smoke"
build_one "semantic-router-moe" "nfn_semantic_router_moe_native_train" \
  ...
  "router-topk-broadcast-smoke,routed-swiglu-expert-forward-backward-smoke,load-balance-loss-adamw-smoke,semantic-hash-alignment-loss-items-smoke,route-selection-distillation-balance-losses-smoke,semantic-router-moe-route-expert-adamw-smoke,family-parameter-layout-checkpoint-inference-smoke"
...
build_one "jamba" "nfn_jamba_native_train" \
  ...
  "jamba-causal-chunk-state-head-adamw-smoke,jamba-mamba-state-forward-backward-adamw-smoke,family-parameter-layout-checkpoint-inference-smoke"
build_one "seq2seq" "nfn_seq2seq_native_train" \
  ...
  "seq2seq-cross-attention-ce-adamw-smoke,seq2seq-loss-composition-adamw-smoke,family-parameter-layout-checkpoint-inference-smoke"
