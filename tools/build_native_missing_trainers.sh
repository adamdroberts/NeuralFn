...
build_one "mixllama" "nfn_mixllama_native_train" \
  ...
  "persistent-full-size-family-parameter-state" \
  "router-topk-broadcast-smoke,routed-swiglu-expert-forward-backward-smoke,load-balance-loss-adamw-smoke,standard-moe-transformer-block-forward-smoke,standard-moe-transformer-block-forward-backward-adamw-smoke,standard-moe-transformer-lm-forward-backward-adamw-smoke,standard-moe-full-forward-backward-loop-smoke,standard-moe-sampled-family-forward-backward-optimizer-step,family-parameter-layout-checkpoint-inference-smoke"
...
build_one "jepa" "nfn_jepa_native_train" \
  ...
  "persistent-full-size-family-parameter-state" \
  "jepa-target-encoder-forward-smoke,jepa-projector-predictor-latent-loss-smoke,ar-plus-jepa-loss-composition-smoke,dense-jepa-ar-target-projector-forward-backward-adamw-smoke,dense-jepa-full-forward-backward-loop-smoke,dense-jepa-sampled-family-dataset-loop,family-parameter-layout-checkpoint-inference-smoke"
...
build_one "jamba" "nfn_jamba_native_train" \
  ...
  "persistent-full-size-family-parameter-state" \
  "jamba-causal-chunk-state-head-adamw-smoke,jamba-mamba-state-forward-backward-adamw-smoke,jamba-layer-schedule-native-loop-smoke,jamba-sampled-family-dataset-loop,family-parameter-layout-checkpoint-inference-smoke"
build_one "seq2seq" "nfn_seq2seq_native_train" \
  ...
  "persistent-full-size-family-parameter-state" \
  "seq2seq-cross-attention-ce-adamw-smoke,seq2seq-loss-composition-adamw-smoke,seq2seq-full-encoder-decoder-loop-smoke,seq2seq-sampled-family-dataset-loop,family-parameter-layout-checkpoint-inference-smoke"
build_one "diffusion" "nfn_diffusion_native_train" \
  ...
  "persistent-full-size-family-parameter-state" \
  "diffusion-denoise-linear-mse-adamw-smoke,diffusion-timestep-mask-ce-adamw-smoke,diffusion-full-loop-smoke,diffusion-sampled-family-dataset-loop,family-parameter-layout-checkpoint-inference-smoke"
...
build_one "hnet-lm" "nfn_hnet_lm_native_train" \
  ...
  "persistent-full-size-family-parameter-state" \
  "hnet-byte-patch-embed-merge-head-adamw-smoke,hnet-byte-patch-backward-adamw-smoke,hnet-byte-lm-loop-smoke,hnet-sampled-byte-family-dataset-loop,byte-token-shard-resolver-smoke,family-parameter-layout-checkpoint-inference-smoke"
build_one "universal-llama" "nfn_universal_llama_native_train" \
  ...
  "persistent-full-size-family-parameter-state" \
  "universal-recurrent-linear-mse-adamw-smoke,universal-act-halt-loss-gradient-smoke,universal-transformer-loop-smoke,universal-sampled-family-dataset-loop,family-parameter-layout-checkpoint-inference-smoke"
