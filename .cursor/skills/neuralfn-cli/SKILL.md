...
- Keep non-GPT-2 training commands and direct legacy training scripts on
  ...
  only when no family binary is available. CLI training entrypoints must not use
