...
SCRIPT_CASES = [
    ...
    ("train_llama_fast", "Train llama_fast through the NeuralFn native CUDA harness."),
    ("train_llama_megakernel", "Train llama_megakernel through the NeuralFn native CUDA harness."),
    ...
    ("train_semantic_router_moe", "Train semantic_router_moe through the NeuralFn native CUDA harness."),
    ("train_semantic_router_moe-overnight", "Train semantic_router_moe overnight through the NeuralFn native CUDA harness."),
