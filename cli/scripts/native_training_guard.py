...
_NATIVE_BOOL_ALIASES = {
    ...
    "--native-cuda-smoke-route-evo-device-controller-step": "--smoke-route-evo-device-controller-step",
    ...
    "--native-cuda-smoke-semantic-target-shard-step": "--smoke-semantic-target-shard-step",
