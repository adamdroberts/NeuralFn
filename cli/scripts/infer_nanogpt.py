...
DEFAULT_WEIGHTS_ARTIFACT = artifact_path("nanogpt.pt")
DEFAULT_GRAPH_ARTIFACT = DEFAULT_WEIGHTS_ARTIFACT.with_suffix(".json")

LOGGER = logging.getLogger("nanogpt_infer")
...
def default_weights_artifact(*, megakernel: bool) -> Path:
    if megakernel:
        return DEFAULT_WEIGHTS_ARTIFACT.with_name("nanogpt_megakernel.pt")
...
def build_parser() -> argparse.ArgumentParser:
    parser = create_argument_parser(description="Run text generation with exported nanogpt artifacts on CUDA.")
    parser.add_argument("--megakernel", action="store_true", help="Use the nanogpt_megakernel artifacts.")
