...
- [ ] Extend native GPT checkpoint text-prompt inference with native tokenization so `.bin` checkpoint inference no longer needs the transitional external sampler bridge.
