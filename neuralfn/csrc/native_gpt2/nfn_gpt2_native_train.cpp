...
bool print_tile_plan(
    ...
    std::cout
        ...
        << (packed_qkv_attention_enabled ? "packed-qkv-bf16-gradient-unpack" : "fused-heads-to-qkv")
        << "\",\n"
        ...
        << (packed_qkv_attention_enabled ? "tk-sm120-packed-qkv-packed-grad-bridge" : "fused-bf16-heads-to-row-qkv")
        << "\",\n"
