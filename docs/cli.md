...
missing-requirements list because they are runnable, and covered non-dense entries
also report an empty list when their smoke-backed native coverage gates are
complete. Covered families have compiled no-Torch native targets for
