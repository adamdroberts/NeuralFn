...
MoE+JEPA entries now list the completed target-encoder forward and
projector/predictor/latent-loss smokes while still reporting full objective
composition, family checkpointing, and inference wiring as missing. Semantic
