...
`nfn_impl` imports. It also imports the native-only GPT-2-evo, NanoGPT,
MixLLaMA, and DeepSeek-V4 shim modules under that same blocker so import-time
