...
directly; it now reports the denoise linear/MSE/backward/AdamW smoke as
completed while timestep scheduling, full objective composition, checkpointing,
...
reports the inner linear/MSE/backward/AdamW smoke as completed while the full
inner-update loop, checkpointing, and inference remain missing.
...
Diffusion entries now list the completed denoise linear/MSE/backward/AdamW
smoke while still reporting timestep scheduling, full objective composition,
checkpointing, and inference wiring as missing.
...
TTT entries now list the completed inner linear/MSE/backward/AdamW smoke while
still reporting the full inner-update loop, checkpointing, and inference wiring
as missing.
Universal transformer entries now list the completed recurrent
linear/MSE/backward/AdamW smoke while still reporting ACT halting,
checkpointing, and inference wiring as missing.
