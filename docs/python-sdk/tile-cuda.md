...
`NativeGpt2RunConfig.lm_head_row_chunk_size` defaults to 2048 and forwards
...
cached. LM-head and dWeight accumulation GEMMs stay on optimized TF32 tensor-op
