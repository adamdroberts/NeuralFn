...
`NativeGpt2RunConfig.lm_head_row_chunk_size` defaults to 1024 and forwards
...
Trainer-facing linear GEMMs use the same native ABI but first try a cached BF16
