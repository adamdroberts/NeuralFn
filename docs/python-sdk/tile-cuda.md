...
`NativeGpt2RunConfig.lm_head_row_chunk_size` defaults to 6144 and forwards
`--lm-head-row-chunk-size` through `compiled_cli_argv()`; pass 4096 explicitly
to reproduce the older smaller-workspace profile. The C++ transformer-LM
