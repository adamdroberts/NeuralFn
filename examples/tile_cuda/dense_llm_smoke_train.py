...
spec = build_model_spec_from_config({"preset": "gpt2", "vocab_size": 128, "num_layers": 1, "model_dim": 32, "num_heads": 4}, preview_defaults=True)
graph = build_gpt_root_graph(name="gpt2_tile_cuda_smoke", model_spec=spec)
